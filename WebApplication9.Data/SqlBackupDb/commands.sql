...
Create table [Department](
	[Id] INT IDENTITY(1,1) PRIMARY KEY,
	[DivisionId] INT REFERENCES [Division](Id),
	[ManagerId] BIGINT REFERENCES [User](Id),
...
Create table [Requisition](
	...
	[DepartmentId] INT REFERENCES [Department](Id),
	[Requisitioned_By] VARCHAR(50),
	[Explanation] VARCHAR(MAX),
	[CFO_approval] BIT,
	[CFO_Explanation] varchar(max),
	[CFO_Decision_By] varchar(50),
...
Create table [ReqAdd](
	[ExtrasId] INT IDENTITY(1,1) PRIMARY KEY,
	[RequisitionId] BIGINT REFERENCES [Requisition](RequisitionId),
	[Comments] VARCHAR(MAX),
	[Date_Ordered] DATE,
	[CC_Holder_Name] VARCHAR(100) NOT NULL,
	[Purchase_Order_Num] VARCHAR(50),
...
Create table [Item](
	...
	[RequisitionId] BIGINT REFERENCES [Requisition](RequisitionId),
	[ItemCategoryId] INT REFERENCES [ItemCategory](ItemCategoryId),
	[Just_Statement] VARCHAR(MAX) NOT NULL,
